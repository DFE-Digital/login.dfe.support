...
const getAllAvailableServices = async (req) => {
  ...
  let externalServices = allServices.services.filter(x => x.isExternalService === true && !(x.relyingParty && x.relyingParty.params && x.relyingParty.params.hideSupport === 'true'));
  if (req.params.uid) {
