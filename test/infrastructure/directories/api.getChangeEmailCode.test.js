...
const { getChangeEmailCode } = require('../../../src/infrastructure/directories/api');
...
describe('when getting a change email code', () => {
  ...
  it('then it should call invitations resource with invitation id', async () => {
    ...
    expect(fetchApi.mock.calls[0][0]).toBe('http://directories.test/usercodes/user-1/changeemail');
