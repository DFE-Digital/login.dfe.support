...
describe('when getting a users organisations mapping from api', () => {
  ...
  it('should return null on a 401 or 404 response', async () => {
    ...
    let result = await deleteInvitationOrganisation(invitationId, organisationId, correlationId);
    ...
    result = await deleteInvitationOrganisation(invitationId, organisationId, correlationId);
    expect(result).toEqual(null);
  });
