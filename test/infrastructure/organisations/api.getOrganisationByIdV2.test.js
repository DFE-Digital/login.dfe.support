...
const { getOrganisationByIdV2 } = require('../../../src/infrastructure/organisations/api');
...
describe('when getting a users organisations mapping from api', () => {
  ...
  it('then it should call associated-with-user resource with user id', async () => {
    ...
    expect(fetchApi.mock.calls[0][0]).toBe('http://organisations.test/organisations/v2/org-1');
